...
class ResNet50UnetPlus(nn.Module):
    ...
    def forward(self, x):
        ...
        x0_0 = x_
        # print('x0_0', x0_0.shape)  # 64 256 256
        x1_0 = e1
        # print('x1_0', x1_0.shape)  # 256 128 128
        x0_1 = self.decoder0_1(([x0_0, upsize(x1_0)]))
        # print('x0_1', x0_1.shape)  # 64 256 256

        x2_0 = e2
        # print('x2_0', x2_0.shape)  # 512 64 64
        x1_1 = self.decoder1_1([x1_0, upsize(x2_0)])
        # print('x1_1', x1_1.shape)  # 256 128 128
        x0_2 = self.decoder0_2([x0_0, x0_1, upsize(x1_1)])
        # print('x0_2', x0_2.shape)  # 64 256 256

        x3_0 = e3
        # print('x3_0:', x3_0.shape)  # 1024 32 32
        x2_1 = self.decoder2_1([x2_0, upsize(x3_0)])
        # print('x2_1:', x2_1.shape)  # 512 64 64
        x1_2 = self.decoder1_2([x1_0, x1_1, upsize(x2_1)])
        # print('x1_2:', x1_2.shape)  # 128 128 128
