...
from DUpsampling import DUpsampling
...
class DecoderBlock(nn.Module):
    def __init__(self,
        ...
        self.relu2 = nn.acon(inplace=True)
...
class ResNet50UnetPlus(nn.Module):
    def __init__(self,
        ...
        self.up4_0 = DUpsampling(2048, 2048, scale_factor=2)
        self.up3_1 = DUpsampling(256, 256, scale_factor=2)
        self.up2_2 = DUpsampling(512, 512, scale_factor=2)
        self.up1_3 = DUpsampling(512, 512, scale_factor=2)
    ...
    def forward(self, x):
        ...
        x0_1 = self.decoder0_1([x0_0, self.up1_0(x1_0)])
...
# MyResNet50UnetPlus = ResNet50UnetPlus(num_class=2)
# print(MyResNet50UnetPlus)
